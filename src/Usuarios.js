...
function Inicio() {
  ...
  function click(userId) {
    console.log(userId);
    history({ pathname: '/perfil/' + userId });
  }
      ...
      <ThemeProvider breakpoints={['xxxl', 'xxl', 'xl', 'lg', 'md', 'sm', 'xs', 'xxs']} minBreakpoint='xxs'>
        ...
        <div>
          {employees.map((employee, index) => {
            return (
              <div key={index} className='usuarios d-flex mx-auto p-1  mb-3' role='button' onClick={() => click(employee.id)}>
